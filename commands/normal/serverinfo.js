        ...
        message.channel.send({
            embed: {
                ...
                fields: [
                    ...
                    { name: "Server Created at:", value: message.guild.createdAt.toLocaleDateString('en-GB') + " " + message.guild.createdAt.toLocaleTimeString('en-GB', { timeZone: "Europe/Amsterdam" }) },
                    ...
                    { name: "You joined at:", value: message.member.joinedAt.toLocaleDateString('en-GB') + " " + message.member.joinedAt.toLocaleTimeString('en-GB', { timeZone: "Europe/Amsterdam" }) },
                ],
                footer: {
