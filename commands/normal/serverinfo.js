        ...
        message.channel.send({
            embed: {
                ...
                fields: [
                    ...
                    { name: "Server Created at:", value: message.guild.createdAt.toLocaleDateString('de-DE', { timeZone: "Europe/Amsterdam", hour12: false }) + " " + message.guild.createdAt.toLocaleTimeString("nl-NL", { timeZone: "Europe/Amsterdam", hour12: false }) },
                    ...
                    { name: "You joined at:", value: message.member.joinedAt.toLocaleDateString('de-DE', { timeZone: "Europe/Amsterdam", hour12: false }) + " " + message.member.joinedAt.toLocaleTimeString("nl-NL", { timeZone: "Europe/Amsterdam", hour12: false }) },
                ],
                footer: {
