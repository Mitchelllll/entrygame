        ...
        message.channel.send({
            embed: {
                ...
                fields: [
                    ...
                    { name: "Server Created at:", value: message.guild.createdAt.toDateString() + " " + message.guild.createdAt.toLocaleTimeString('en-GB') },
                    ...
                    { name: "You joined at:", value: message.member.joinedAt.toDateString() + " " + message.member.joinedAt.toLocaleTimeString('en-GB') },
                ],
                footer: {
