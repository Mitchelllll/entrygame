        ...
        message.channel.send({
            embed: {
                ...
                fields: [
                    ...
                    { name: "Server Created at:", value: message.guild.createdAt.toLocaleDateString('nl-NL') + " " + message.guild.createdAt.toLocaleTimeString('nl-NL', { timeZone: "Europe/Amsterdam" }) },
